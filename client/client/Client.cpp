...
bool Client::_SendInt(int _int)
{
	//int ReturnCheck = send(connection, (char*)&_int, sizeof(int), NULL);
	//if (ReturnCheck == SOCKET_ERROR)
	//	return false;
	if (!_SendAll((char*)&_int, sizeof(int)))
		return false;
	return true;
}
bool Client::_GetInt(int& _int)
{
	//int ReturnCheck = recv(connection, (char*)&_int, sizeof(int), NULL);
	//if (ReturnCheck == SOCKET_ERROR)
	//	return false;
	if (!_RecvAll((char*)&_int, sizeof(int)))
		return false;
	return true;
}
